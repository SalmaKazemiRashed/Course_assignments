function cifar10_starter_batch_norm()
    addpath(genpath('./'));
    ...
    %%   
       net.layers{end+1} = struct('type', 'batchnorm',...
         'params', struct('weights', 0.1*randn(1,8)/sqrt(1/2), 'biases',  zeros(1,8)));
%          %'padding', [2 2]);
    %%
...
%     
    ...
    save('models/cifar10_baseline_batchnorm.mat', 'net');
    ...
    save('models/cifar10_result_batchnorm.mat', 'pred');
